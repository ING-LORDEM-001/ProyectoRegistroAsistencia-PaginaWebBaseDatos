...
<html lang="en">
    ...
    <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
        <table>
            <tr>
                <th colspan="2"><h1 class="titulo__pagina">Lista de Maestros</h1></th>
            </tr>
            <tr>
                <td>
    ...
    <tbody>
        ...
        if(isset($_POST['enviar'])){
            ...
            if(empty($_POST['Cod_Identificacion'])){
                ...
                if(!empty($_POST['Cod_Identificacion'])){
                    $sql="select * from tbmaestros where Cod_Identificacion like '%".$Cod_Identificacion."%'";
